...
const sections = [
  ...
  ...flowCategories.map((c) => ({ id: c.id, label: c.title })),
  { id: "principles", label: "AI & Dashboard Rules" },
];

export default function UXFlowsNav() {
      ...
      <div className="px-6 py-6">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400 -mt-0.5">UX Flows</p>
          </div>
        </Link>
      </div>
