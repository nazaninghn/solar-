...
- [`go-live-readiness.md`](go-live-readiness.md) — **new (Step 89)**: honest go-live checklist — what's technically verified vs. what requires real human action (deploy trigger, stakeholder sign-off); `scripts/smoke_test.py` is the runnable post-deploy check
